    ...
    <div className="min-h-screen bg-[#ededed] font-sans overflow-x-hidden" dir="ltr">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-24 pb-20">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-blue-300 text-xs font-semibold uppercase tracking-widest px-4 py-1.5 rounded-full mb-8">
            <FaUsers className="text-[10px]" />
            Notre histoire
          </div>
          <h1 className="text-5xl sm:text-6xl font-extrabold text-gray-500 leading-tight mb-6">
            À propos de{' '}
            <span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">
              Amana
            </span>
          </h1>
          <p className="text-lg text-gray-500/55 leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
          {stats.map((s) => (
            <div key={s.label} className="text-center">
              <p className="text-3xl font-extrabold bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">
                {s.value}
              </p>
      ...
      <section className="py-28 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-base text-gray-500/45 text-center max-w-xl mx-auto mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {values.map((v) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${v.color} text-gray-500 text-xl mb-5 shadow-lg`}>
                  {v.icon}
                </div>
                <h3 className="text-lg font-bold text-gray-500 mb-2">{v.title}</h3>
                <p className="text-gray-500/50 leading-relaxed text-sm">{v.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-28 overflow-hidden text-center border-t border-white/5">
        <div className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-blue-700/15 blur-[120px] rounded-full" />
        <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-500 leading-tight mb-6">
            Prêt à lancer{' '}
            <span className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent">
              votre assurance ?
            </span>
          </h2>
          <p className="text-base text-gray-500/50 mb-10 max-w-lg mx-auto">
